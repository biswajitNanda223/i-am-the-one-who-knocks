...
For a guided progression with TypeScript examples and exercises, start the [beginner-to-advanced course](course/README.md). For working controls and CI gates, continue with [security automation](security-automation.md). For the wider defensive context, see [how AppSec fits into cybersecurity](cybersecurity-map.md).
